...
////////////////////////////////////////////////////////////////////////////////
  ...
  function GetMediaMajorTypeDescription(MediaType: PAMMediaType): string;
  function GetMediaSubTypeDescription(MediaType: PAMMediaType): string;
  function GetMediaFormatTypeDescription(MediaType: PAMMediaType): string;
...
// *****************************************************************************
  ...
  private
    ...
    function   GetMediaMajorDescription(Index: Integer): string;
    function   GetMediaSubDescription(Index: Integer): string;
    function   GetMediaFormatDescription(Index: Integer): string;
  ...
  public
    ...
    property    MediaMajorDescription[Index: Integer]: string read GetMediaMajorDescription;
    property    MediaSubDescription[Index: Integer]: string read GetMediaSubDescription;
    property    MediaFormatDescription[Index: Integer]: string read GetMediaFormatDescription;
...
begin
 ...
 //----------------------------------------------------------------------------
  ...
  begin
    // major types
    result := 'Major Type: ';
    result := result + GetMediaMajorTypeDescription(MediaType);
    
    // sub types
    result := result + ' - Sub Type: ';
    result := result + GetMediaSubTypeDescription(MediaType);

    // format
    result := result+ ' Format: ';
    result := result + GetMediaFormatTypeDescription(MediaType);
  end;
...
//******************************************************************************
  ...
  function TEnumMediaType.GetMediaMajorDescription(Index: Integer): string;
  begin
    result := '';
    if ((index < count) and (index > -1)) then
      result := GetMediaMajorTypeDescription(TMediaType(Flist.Items[index]).AMMediaType);
  end;
  
  function TEnumMediaType.GetMediaSubDescription(Index: Integer): string;
  begin
    result := '';
    if ((index < count) and (index > -1)) then
      result := GetMediaSubTypeDescription(TMediaType(Flist.Items[index]).AMMediaType);
  end;
  
  function TEnumMediaType.GetMediaFormatDescription(Index: Integer): string;
  begin
    result := '';
    if ((index < count) and (index > -1)) then
      result := GetMediaFormatTypeDescription(TMediaType(Flist.Items[index]).AMMediaType);
  end;
